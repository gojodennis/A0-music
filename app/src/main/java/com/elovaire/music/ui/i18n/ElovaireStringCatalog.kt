...
internal fun rootUiCopy(language: AppLanguage): RootUiCopy = when (language) {
    AppLanguage.Polish -> RootUiCopy(
        ...
        firstLaunchPermissionMessage = "A;0 skanuje folder Muzyka na urządzeniu, aby znaleźć lokalne albumy, okładki i kolejki utworów",
    ...
    AppLanguage.Slovak -> RootUiCopy(
        ...
        firstLaunchPermissionMessage = "A;0 prehľadáva priečinok Music v zariadení a hľadá lokálne albumy, obaly a fronty skladieb",
    ...
    AppLanguage.Korean -> RootUiCopy(
        ...
        firstLaunchPermissionMessage = "A;0가 기기의 Music 폴더를 스캔하여 로컬 앨범, 아트워크, 트랙 대기열을 찾습니다",
    ...
    AppLanguage.Malay -> RootUiCopy(
        ...
        firstLaunchPermissionMessage = "A;0 mengimbas folder Music pada peranti untuk album tempatan, karya seni dan barisan trek",
    ...
    AppLanguage.Bengali -> RootUiCopy(
        ...
        firstLaunchPermissionMessage = "A;0 আপনার ডিভাইসের Music ফোল্ডার স্ক্যান করে স্থানীয় অ্যালবাম, কভার আর্ট ও ট্র্যাক কিউ খুঁজে নেয়",
        ...
        appUpToDate = "A;0 সর্বশেষ সংস্করণে আছে",
    ...
    AppLanguage.Urdu -> RootUiCopy(
        ...
        firstLaunchPermissionMessage = "A;0 آپ کے آلے کے Music فولڈر کو اسکین کرتا ہے تاکہ مقامی البمز، آرٹ ورک اور ٹریک قطاریں تلاش کی جا سکیں",
        ...
        firstLaunchPermissionMessage = "A;0 scans the device Music folder for local albums, artwork, and track queues",
